...
override PKGDIR = xconfig_protocol
...
package/%.xdc.inc package/%_xconfig_protocol.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_protocol" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: protocol.pem3

-include package/cfg/protocol_pem3.mak
-include package/cfg/protocol_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/protocol_pem3.dep
endif
protocol.pem3: package/cfg/protocol_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
protocol.pem3 package/cfg/protocol_pem3.c: .libraries,em3
endif

package/cfg/protocol_pem3.c package/cfg/protocol_pem3.h package/cfg/protocol_pem3.xdl: override _PROG_NAME := protocol.xem3
package/cfg/protocol_pem3.c: package/cfg/protocol_pem3.cfg
package/cfg/protocol_pem3.xdc.inc: package/cfg/protocol_pem3.xdl
package/cfg/protocol_pem3.xdl package/cfg/protocol_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/protocol_pem3.cfg
	-$(RM) package/cfg/protocol_pem3.dep
	-$(RM) package/cfg/protocol_pem3.c
	-$(RM) package/cfg/protocol_pem3.xdc.inc

clean,em3::
	-$(RM) protocol.pem3
.executables,em3 .executables: protocol.xem3

protocol.xem3: |protocol.pem3

-include package/cfg/protocol.xem3.mak
protocol.xem3: package/cfg/protocol_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/protocol_pem3.oem3   package/cfg/protocol_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
protocol.xem3: export C_DIR=
protocol.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
protocol.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

protocol.test test,em3 test: protocol.xem3.test

protocol.xem3.test:: protocol.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 protocol.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.protocol.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,protocol.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
protocol_pem3.oem3,copy : package/cfg/protocol_pem3.oem3
protocol_pem3.sem3,copy : package/cfg/protocol_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_protocol
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_protocol.tar.dep
endif
package/rel/xconfig_protocol/xconfig_protocol/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_protocol/xconfig_protocol/package/package.rel.xml: package/build.cfg
package/rel/xconfig_protocol/xconfig_protocol/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_protocol/xconfig_protocol/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_protocol.tar: package/rel/xconfig_protocol.xdc.inc package/rel/xconfig_protocol/xconfig_protocol/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_protocol.xdc.inc,package/rel/xconfig_protocol.tar.dep)


release release,xconfig_protocol: all xconfig_protocol.tar
clean:: .clean
	-$(RM) xconfig_protocol.tar
	-$(RM) package/rel/xconfig_protocol.xdc.inc
	-$(RM) package/rel/xconfig_protocol.tar.dep
