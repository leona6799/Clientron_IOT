...
linker.cmd: package/cfg/empty_pem3.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem3cfg.cmd\)\"$""\"D:/03565-BenChiu/workspace_v6_1_3/CC2650DK_7ID_TI_CC2650F128_Protocol/.config/xconfig_empty/\1\""' package/cfg/empty_pem3.xdl > $@
